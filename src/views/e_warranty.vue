      ...
      <div class="form-card">
        ...
        <div class="form-content">
          ...
          <div class="form-section">
            <h2 class="section-title">ข้อมูล Product</h2>
            <div class="form-row">
              <div class="form-group">
                <label>Product ID</label>
                <input type="text" v-model="formData.product_id" placeholder="Product ID" />
              </div>
              <div class="form-group">
          ...
          <div v-if="formData.product_id">
            <img alt="Vue logo" src="../assets/S__58220548.jpg">
          </div>
          <!-- ข้อมูลโช้คและรถยนต์ -->
          <div class="form-section">
            ...
            <div class="form-row">
              <div class="form-group">
                <label>ID</label>
                <input type="text" v-model="formData.product_id" placeholder="ID" />
              </div>
              <div class="form-group">
                <label>เลขทะเบียนรถ</label>
                <input type="text" v-model="formData.carnumber" placeholder="เลขทะเบียนรถ" />
              </div>
              <div class="form-group">
                <label>ยี่ห้อรถ</label>
                <input type="text" v-model="formData.carbrand" placeholder="ยี่ห้อรถ" />
              </div>
              <div class="form-group">
                <label>รุ่น/ปี</label>
                <input type="text" v-model="formData.carmodel" placeholder="รุ่น/ปี" />
              </div>
            </div>
          </div>
          ...
          <div class="form-section">
            ...
            <div class="form-row">
              <div class="form-group full-width">
                ...
                <input type="text" v-model="formData.name" placeholder="ชื่อ-นามสกุลผู้ซื้อ" />
              </div>
            </div>
            <div class="form-row">
              <div class="form-group">
                <label>บ้านเลขที่</label>
                <input type="text" v-model="formData.housenumber" placeholder="บ้านเลขที่" />
              </div>
              <div class="form-group">
                <label>หมู่บ้าน/อาคาร</label>
                <input type="text" v-model="formData.village" placeholder="หมู่บ้าน/อาคาร" />
              </div>
              <div class="form-group">
                <label>ซอย</label>
                <input type="text" v-model="formData.alley" placeholder="ซอย" />
              </div>
            </div>
            <div class="form-row">
              <div class="form-group">
                <label>ถนน</label>
                <input type="text" v-model="formData.road" placeholder="ถนน" />
              </div>
              <div class="form-group">
                <label>แขวง/ตำบล</label>
                <input type="text" v-model="formData.subdistrict" placeholder="แขวง/ตำบล" />
              </div>
              <div class="form-group">
                <label>เขต/อำเภอ</label>
                <input type="text" v-model="formData.district" placeholder="เขต/อำเภอ" />
              </div>
            </div>
            <div class="form-row">
              <div class="form-group">
                <label>จังหวัด</label>
                <input type="text" v-model="formData.province" placeholder="จังหวัด" />
              </div>
              <div class="form-group">
                <label>รหัสไปรษณีย์</label>
                <input type="text" v-model="formData.zipcode" placeholder="รหัสไปรษณีย์" />
              </div>
              <div class="form-group">
                <label>เบอร์โทร</label>
                <input type="text" v-model="formData.telephonenumber" placeholder="เบอร์โทร" />
              </div>
            </div>
          </div>
          ...
          <div class="form-section">
            ...
            <div class="form-row">
              <div class="form-group">
                ...
                <input type="text" v-model="formData.namestaller" placeholder="ชื่อร้าน/ศูนย์ติดตั้งโช้ค" />
              </div>
              <div class="form-group">
                <label>ติดตั้งวันที่</label>
                <input type="text" v-model="formData.installerdate" placeholder="ติดตั้งวันที่" />
              </div>
              <div class="form-group">
                <label>เบอร์โทร</label>
                <input type="text" v-model="formData.installertelephone" placeholder="เบอร์โทร" />
              </div>
            </div>
            <div class="form-row">
              <div class="form-group double-width">
                <label>ที่อยู่</label>
                <input type="text" v-model="formData.installeraddress" placeholder="ที่อยู่" />
              </div>
              <div class="form-group">
                <label>รหัสไปรษณีย์</label>
                <input type="text" v-model="formData.zipcodeinstaller" placeholder="รหัสไปรษณีย์" />
              </div>
            </div>
            <div class="form-row">
              <div class="form-group">
                <label>หมายเลขกิโลที่เริ่มติดตั้ง</label>
                <input type="text" v-model="formData.startofinstall" placeholder="หมายเลขกิโลที่เริ่มติดตั้ง" />
              </div>
            </div>
          </div>
          ...
          <div class="warning-section">
            <p class="warning-text">
              *โปรดกรอกข้อความให้ละเอียดชัดเจนและส่งมายังบริษัทฯ ภายใน 14 วัน นับจากวันที่ติดตั้ง
...
export default {
  ...
  methods: {
    ...
    handleScanQR(data) {
      ...
      console.log('this.selectedData', this.selectedData.number)
      this.generateQR(this.selectedData.number)
    },
